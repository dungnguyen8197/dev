    ...
    <div class="section-container px-0 support-complete__container">
      <PageSection v-if="support.team_name" pc-transperant>
        ...
        <div class="bg-white px-16 py-8 mt-16">
          <div>
            <span class="badge badge-secondary mr-10">{{ purchaseTypeName }}</span>
      ...
      <div class="mb-25 mt-40">
        <div class="font-18 px-16">支援者名簿</div>
        <div class="mt-6 text-base px-16">
          {{ support.organization_name }}{{ support.team_name }}の支援者名簿へあなたの支援履歴が追記されました。
        </div>
        <div v-if="support.is_anonymous" class="mt-6 text-sm px-16">
          ※匿名で支援を受け付けたため、支援者名簿にお名前は掲載されません。
        </div>
        <div class="ranking">
          <TeamActivitySupporters
            :supporters="supporters"
            :supporters-url="`/organizations/${support.organization_id}/teams/${support.team_id}/supporters`"
          />
...
export default defineComponent({
  components: { PageSection, Footer, TeamActivitySupporters },
  setup() {
