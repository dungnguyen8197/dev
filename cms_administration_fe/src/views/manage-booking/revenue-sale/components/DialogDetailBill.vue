<template>
  <el-dialog title="Thông tin chi tiết" :visible.sync="showDialog" width="95%" :before-close="handleClose">
    <div
    ...
    >
      <el-row class="p-10 border-1 pb-10 mb-10">
        ...
        <!-- BK -->
        <el-row v-if="typeChooseBillSelect === 1">
          <el-row class="dialog-add-golfer pb-10">
            ...
            <el-col class="p-10" :xs="24" :sm="12" :md="8" :lg="4" :xl="4">
              ...
              <div v-if="+postForm.order_type === 2" class="mt-10">
                <search-user
            ...
            <el-col class="p-10" :xs="24" :sm="12" :md="8" :lg="4" :xl="4">
              <label>Loại hố</label>
              <br>
              <el-select v-model="postForm.type_hole" disabled placeholder="Loại hố">
            ...
            <el-col v-if="isShowHIO" class="p-10" :xs="24" :sm="12" :md="8" :lg="4" :xl="4">
              ...
              <br>
              <el-select v-model="postForm.insurance_pax" disabled clearable placeholder="Chọn bảo hiểm">
                <el-option
            ...
            <el-col class="p-10">
              <el-button disabled type="primary" size="mini" @click="searchTeeTime">Tìm Tee Time</el-button>
            </el-col>
            <el-col class="p-10" :xs="24" :sm="12" :md="8" :lg="4" :xl="4">
              <label>Teetime</label>
              <br>
        ...
        <el-row v-else>
          <el-row class="dialog-add-golfer pb-10">
            <el-col class="p-10" :xs="24" :sm="12" :md="8" :lg="4" :xl="4">
              ...
              <el-input v-model="postForm.name_tour" disabled class="w-100" placeholder="Nhập tên giải đấu" />
            </el-col>
            <el-col class="p-10" :xs="24" :sm="12" :md="8" :lg="4" :xl="4">
              <label> Chọn sân đánh </label>
              <br>
              <el-select
                v-model="facilityModelHIO"
                disabled
                class="w-100"
                filterable
                remote
              ...
              >
                <el-option
                  v-for="facility in facilitiesHIO"
                  :key="facility.value"
                  :label="facility.label"
                  :value="facility"
                />
            ...
            <template v-if="paths.length > 0">
              <el-col class="p-10" :xs="24" :sm="12" :md="8" :lg="4" :xl="4">
                ...
                <div class="clearfix-5" />
                <el-select v-model="optionPricePackage" disabled class="w-100" placeholder="Chọn gói bảo hiểm muốn mua">
                  <el-option
            ...
            <el-col class="p-10" :xs="24" :sm="12" :md="8" :lg="4" :xl="4">
              ...
              <div class="clearfix-5" />
              <el-select v-model="typeChoosePay" disabled class="w-100" placeholder="Chọn trạng thái gửi đơn PVI">
                <el-option
            ...
            <el-col class="p-10" :xs="24" :sm="12" :md="8" :lg="4" :xl="4">
              <label>Chọn đại lý bán BH:</label>
              <div class="clearfix-5" />
              <el-select
                v-model="agent"
                disabled
              ...
              >
                <el-option
                  v-for="agentId in agentInsurance"
                  :key="agentId.value"
                  :label="agentId.label"
                  :value="agentId.value"
                />
            ...
            <el-col class="p-10" :xs="24" :sm="12" :md="8" :lg="4" :xl="4">
              <label>Số lượng người tham gia giải đấu:</label>
              <div class="clearfix-5" />
              <el-input v-model="number_user" class="w-100" placeholder="Số người tham gia" disabled />
            </el-col>
            <el-col class="p-10" :xs="24" :sm="12" :md="8" :lg="4" :xl="4">
              <label>Xác nhận giải outing:</label>
              <div class="clearfix-5" />
              <el-checkbox v-model="checked" disabled label="1">Outing</el-checkbox>
            </el-col>
          </el-row>
        </el-row>
      </el-row>
      <!-- HIO -->
      <span v-if="typeChooseBillSelect === 0" slot="footer" class="dialog-footer">
        <el-row class="p-10 border-1 mb-10">
          <el-row class="dialog-add-golfer">
            ...
            <el-col v-if="isInsideVhandicap === 1" class="mb-2">
              <div class="clearfix-5" />
              <div class="search-golfer">
                <el-select
                  v-model="postFormHio.user_id"
                  class="w-100"
                  filterable
                  remote
                  reserve-keyword
                  placeholder="Tìm kiếm mã VID"
                  :remote-method="handleSearchGolfers"
                  :loading="loadingSearchUser"
                  @keydown.enter.native="onKeydownEnter"
                  @change="onChangeGolferCreate"
                >
                  <el-option
            ...
            <el-col v-if="isInsideVhandicap === 0" class="mb-2">
              <div class="clearfix-5" />
              <el-row style="padding-bottom: 10px">
                <el-col :sm="24">
                  <el-input
                    v-model="postFormHio.name"
                    type="text"
              ...
              <el-row style="padding-bottom: 10px">
                <el-col :sm="24">
                  <el-input
                    v-model="postFormHio.value_user"
                    type="text"
              ...
              <el-row>
                <el-col style="text-align: center">
                  <el-button type="primary" @click="getValuePass()">Xác nhận thông tin</el-button>
                </el-col>
              </el-row>
            </el-col>
          </el-row>
        ...
        <el-row class="lists-data-passport" style="padding-top: 20px; padding-left: 10px; padding-bottom: 20px">
          <label>Danh sách golfer tham gia giải: <span class="required">*</span></label>
          <div class="clearfix-5" style="padding-top: 20px" />
          <el-col
            v-for="(user) in listsPassports"
            :key="user.passport"
            :lg="8"
            :md="8"
            :sm="8"
          ...
          >
            <div class="block">
              <el-row class="position-relative">
                <el-col class="font-11" :sm="20" :xs="22">
                  <el-col class="mb-1" style="padding-bottom: 10px">KH:
                    <strong>{{ user.name }}</strong> -
                    Cccd/Passport:<strong>{{ user.passport }}</strong></el-col>
                </el-col>
                <div class="btn-remove-golfer">
                  <i class="el-icon-delete" @click="onRemovePassport(user)" />
                </div>
              </el-row>
            </div>
          </el-col>
        </el-row>
        <el-row class="lists-data-golfer">
          <el-col
            v-for="(golfer) in listsGolfers"
            :key="golfer.value"
            :lg="6"
            :md="8"
            :sm="8"
          ...
          >
            <div class="block">
              <el-row class="position-relative">
                <el-col :sm="6" :xs="6">
                  <el-avatar-custom
                    :avatar-path="golfer.golfer.system_avatar_path"
                    :avatar-path-default="golfer.golfer.system_avatar_default"
                  />
                </el-col>
                <el-col class="font-11" :sm="14" :xs="16">
                  <el-col class="mb-1"><strong>Mã:</strong> VID{{ golfer.golfer.id }}</el-col>
                  <el-col class="mb-1"><strong>Họ tên:</strong>{{ golfer.golfer.fullname }}</el-col>
                  <el-col class="mb-1"><strong>Nickname:</strong> {{ golfer.golfer.nickname }}
                  </el-col>
                </el-col>
                <div class="btn-remove-golfer">
                  <i class="el-icon-delete" @click="onRemoveGofer(golfer)" />
                </div>
              </el-row>
            </div>
          </el-col>
        ...
        <el-row v-if="listsGolferError.length > 0">
          ...
          <el-col
            v-for="(golfer) in listsGolferError"
            :key="golfer.value"
            class="pr-lg-5"
          >
            <el-col class="mb-1"><strong>Mã:</strong> vID{{ golfer.golfer.id }}</el-col>
        ...
        <el-button type="primary" @click="onSubmitCreateHIO">
          Tạo bảo hiểm
        </el-button>
      </span>
      <!-- BK -->
...
import { listOrderType, listHIO, listService, listTypeHole, LIST_TYPE_CARD_SCB } from '@/utils/defaultOptions'
  ...
  data() {
    return {
      ...
      postForm: {
        ...
        type_hole: 18,
        insurance_pax: 0,
        insurance_pax_d20: 1, // 0: không tặng, 1: có d20
        note: '',
        code_booking_relate: ''
  ...
  computed: {
    checkDatePlayed() {
      if (this.postForm.pax_id && this.postForm.dayPlayed) {
        ...
        const dayPlayed = moment(this.postForm.dayPlayed, 'DD-MM-YYYY').startOf('day')
        const now = moment().startOf('day')
        if (dayPlayed.isBefore(now)) {
  ...
  watch: {
    ...
    datePlayed(value) {
      if (value !== null) {
        ...
        if (dateNow <= dateSelected) {
          ...
          this.postFormHio.date_played = `${stringDate} ${this.timePlayedHio}`
        } else {
          this.$message.warning('Vui lòng chọn ngày hơn ngày hiện tại!')
          this.postFormHio.date_played = ''
        }
      }
    },
    timePlayedHio(value) {
      const stringDate = this.handleConvertDatePlayed(this.datePlayed)
      this.postFormHio.date_played = `${stringDate} ${value}`
    },
    typeChoosePay(value) {
      this.postFormHio.is_pay = value
    },
    optionsMemberModel(value) {
      if (Object.keys(value).length > 0) {
        this.postFormHio.options_member_id = 6
      }
    },
    optionPricePackage(value) {
      if (typeof value === 'object') {
        this.postFormHio.options_money_id = value.value
      } else {
        this.postFormHio.options_money_id = value
      }
    },
    dataGolfers(value) {
      if (value.length > 0) {
        this.postFormHio.golfers = [...value]
      }
    },
    dataPassport(value) {
      this.postFormHio.passport = [...value]
    },
    facilityModelHIO(value) {
      if (Object.keys(value).length > 0) {
        this.paths = value.paths
        if (this.paths.length > 1) {
          this.postFormHio.path_id1 = this.paths[0].id
          this.postFormHio.path_id2 = this.paths[1].id
          this.pathModel2 = this.paths[1].id
        }
        this.postFormHio.facility_id = value.value
        this.onGetListPrices(this.postFormHio)
      }
    },
    pathModel2(value) {
      if (value !== 0) {
        this.postFormHio.path_id2 = value
      }
    },
    objectGolfer(value) {
      if (Object.keys(value).length > 0) {
    ...
    checked(value) {
      if (value) {
        console.log(value)
        if (value === true) {
          this.postFormHio.is_outing = 1
        } else {
          this.postFormHio.is_outing = 0
        }
      }
    }
  },
  ...
  methods: {
    ...
    async onGetDetail(id) {
      ...
      if (res.error_code === 0) {
        ...
        if (data.pax) {
          ...
          this.dayPlayedModel = data?.pax?.date_played
          this.salePaxForm = {
        ...
        this.postForm = {
          ...
          type_refund: data?.pax && data?.pax?.agency_name ? data?.pax?.agency_name : 'Người nhận hoàn tiền',
        ...
        if (!isEmpty(data.parent_id) && data.parent_id !== 0) {
          await bookingPaxResource.detailBill({ bill_id: data.parent_id }).then(response => {
            if (res.error_code === 0) {
              ...
              this.billSearch.push({ value: response.data.general_bill_id, label: response.data.code })
            }
          })
        }
      } else {
    ...
    resetDataModal() {
      ...
      this.postForm = {
        ...
        service: [],
        order_type: 1,
        type_refund: 'Người nhận hoàn tiền',
        host_user_id: null,
        path_id: null,
        total_price: 0,
        type_hole: 18,
    ...
    handleClose() {
      this.$emit('clickButtonDialogDetail', true)
      this.resetDataModal()
    },
    ...
    handleAgency(key) {
      ...
      const price = agency.data.price_facility.find(item => item.id === this.facilityModel.value)
      if (!isEmpty(price)) {
        const today = moment(this.postForm.dayPlayed, 'DD-MM-YYYY')
        const day = today.day()
        if (day === 0 || day === 6) {
          this.listGolfers[key].price_angency = price.booking_pax_agency_facility_price.holiday_price
        } else {
          this.listGolfers[key].price_angency = price.booking_pax_agency_facility_price.normal_price
        }
      } else {
        delete this.listGolfers[key].price_angency
      }
    ...
    checkDisabled(val) {
      if (val.booked && val.booked.type_purchase !== null && +val.booked.type_purchase !== 0 && +val.booked.price_booking !== 0) {
        return true
      } else {
        return false
      }
    ...
    handleSetData(data, dataError) {
      this.dataGolfers = [...data]
      this.dataGolfersError = [...dataError]
      if (data.length > 0) {
        const itemOne = data[0]
        const check = this.golferByInsurances.filter(item => item.value === itemOne.value)
        if (check.length === 0) {
          this.golferByInsurances.push(itemOne)
          this.postFormHio.user_id = itemOne.value
        }
        this.onGetList()
      } else {
        this.listsGolfers = []
    ...
    getValuePass(value) {
      const cccd = this.postFormHio.value_user
      const name = this.postFormHio.name

      if (name === '' || cccd === undefined || name === undefined || cccd === '') {
        this.$message.warning('Name hoặc passport không được để trống!')
      } else {
        const objectName = Object({ name: name })
        const objectCCCD = Object({ passport: cccd })
        const mergeObj = { ...objectName, ...objectCCCD }
        console.log(mergeObj)
        console.log('aaaaaaaa', this.dataPassport)
        this.dataPassport.push(mergeObj)
        this.total_passport = this.dataPassport.length
        this.number_user = this.total_passport + this.total_user
        this.postFormHio.value_user = ''
        this.postFormHio.name = ''
        this.onGetPassport()
      }
    },
    onGetList() {
