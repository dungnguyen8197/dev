    ...
    <el-row class="data-table-content table-responsive">
      <table class="table-golfer border table-bordered w-100">
        <thead>
          ...
          <th class="p-10 text-center word-break" style="min-width: 180px;">Tên</th>
          <th class="p-10 text-center word-break" style="min-width: 180px;">Phụ phí</th>
          <th class="p-10 text-center word-break" style="min-width: 180px;">Giá nhập phụ phí</th>
        </thead>
        <tbody>
          <tr v-for="(b, index) in booked" :key="index">
            <td class="text-center">{{ index + 1 }}</td>
            <td class="text-center">{{ b.golfer ? b.golfer.fullname : b.name_out_system }}</td>
