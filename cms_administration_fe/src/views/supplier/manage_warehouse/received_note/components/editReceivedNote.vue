<template>
  <el-dialog
    ...
    width="90%"
  >
    <editTableNote v-if="showEditTableNote" :type="typeHandleDialog" :dialog-form-visible="showEditTableNote" :data-body-old="dataEditRow" :warehouse-id="id" :shop-id="dataBody.shop_id" @on-close="showEditTableNote=false" @on-add="addRowNote" @on-edit="editRowNote" />
