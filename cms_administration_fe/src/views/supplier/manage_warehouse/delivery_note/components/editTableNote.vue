        ...
        <div style="display: flex; justify-content: space-between;">
          ...
          <div class="div-product">
            ...
            <el-form-item prop="price">
              <el-input
                :value="dataBody.price ? formatNumber(dataBody.price) : null"
                prop="price"
...
export default {
  ...
  methods: {
    ...
    onAddProduct() {
      // this.dataBody.cost = parseInt(this.dataBody.price * this.dataBody.origin_number)
      ...
      warehouseApi
        ...
        .then(response => {
          ...
          if (error === 0) {
            ...
            throw new Error('Không lấy được danh sách sản phẩm 2nd')
          }
        })
        .catch(error => {
          this.$message.error(error.message)
